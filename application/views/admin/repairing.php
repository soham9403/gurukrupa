...
<main>
	...
	<div class="title_row" id="title_of_category" style="margin-top: 120px;">
		...
		<button   onclick="open_form(<?php echo('\''.get_uri('admin_repairing/modalform').'\''); ?>)" class="primary-theme"><?php echo(lang('add')); ?> <i class="fa fa-plus"></i></button>
	</div>
	<div class="box-row">
...
<script type="text/javascript">
	...
	function get_data(){
		...
		$.ajax({
			url : "<?php echo(get_uri('admin_repairing/get_data')); ?>",
			method:"POST",
			// data:data,
