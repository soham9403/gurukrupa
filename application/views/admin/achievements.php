...
<main>
	...
	<div class="title_row" id="title_of_category" style="margin-top: 120px;">
		...
		<button   onclick="open_form(<?php echo('\''.get_uri('achievements/modalform').'\''); ?>)" class="primary-theme"><?php echo(lang('add')); ?> <i class="fa fa-plus"></i></button>
	</div>
	<div class="box-row">
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".header_link_list li").eq(5).removeClass('hover-theme');
		$(".header_link_list li").eq(5).addClass('primary-theme');
		get_data();
	})
	function get_data(){
		...
		$.ajax({
			url : "<?php echo(get_uri('achievements/get_data')); ?>",
			method:"POST",
			// data:data,
